...
hiddenlayer = LeakyReluLayer(negative_slope=0.35, in_dim=n, layer_dim=n,
                                   ...
                                   debug_mode=debug,
                                   weight_decay=weight_decay)
hiddenlayer2 = LeakyReluLayer(negative_slope=0.35, in_dim=n, layer_dim=n,
                                   writer=writer,
                                   name='hidden_layer2',
                                   debug_mode=debug,
                                   weight_decay=weight_decay)
...
optimizer1 = SGD(network=network, threshold=0.0001,
                 ...
                 tau=100,
                 final_learning_rate=learning_rate/5, compute_accuracies=False,
                 max_epoch=max_epoch,
