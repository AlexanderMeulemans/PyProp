...
hidden_layer1_true = LeakyReluLayer(negative_slope=0.35, in_dim=n, layer_dim=n,
                                   writer=writer,
                                   name='hidden_layer1_true_model',
                                   debug_mode=debug,
                                   weight_decay=weight_decay)
...
output_layer_true = LinearOutputLayer(in_dim=n, layer_dim=n,
                                      ...
                                      debug_mode=debug,
                                      weight_decay=weight_decay)
true_network = Network([input_layer_true, hidden_layer1_true,
                        hidden_layer2_true,
                        output_layer_true])
...
hidden1_weights_true = hidden_layer1_true.forward_weights
hidden2_weights_true = hidden_layer2_true.forward_weights
...
output_weights = hf.get_invertible_neighbourhood_matrix(output_weights_true,
                                                        distance)
hidden1_weights = hf.get_invertible_neighbourhood_matrix(hidden1_weights_true,
                                                        distance)
hidden2_weights = hf.get_invertible_neighbourhood_matrix(hidden2_weights_true,
                                                        distance)
...
inputlayer = InvertibleInputLayer(layer_dim=n, out_dim=n, loss_function='mse',
                                  ...
                                  debug_mode=debug,
                                  weight_decay=weight_decay)
hiddenlayer1 = InvertibleLeakyReluLayer(negative_slope=0.35, in_dim=n,
                                       ...
                                       debug_mode=debug,
                                       weight_decay=weight_decay)
hiddenlayer2 = InvertibleLeakyReluLayer(negative_slope=0.35, in_dim=n,
                                       layer_dim=n, out_dim=n, loss_function=
                                       'mse',
                                       name='hidden_layer2',
                                       writer=writer,
...
outputlayer = InvertibleLinearOutputLayer(in_dim=n, layer_dim=n,
                                          ...
                                          debug_mode=debug,
                                          weight_decay=weight_decay)
hiddenlayer1.set_forward_parameters(hidden1_weights, hiddenlayer1.forward_bias)
hiddenlayer2.set_forward_parameters(hidden1_weights, hiddenlayer2.forward_bias)
outputlayer.set_forward_parameters(output_weights, outputlayer.forward_bias)

network = InvertibleNetwork([inputlayer, hiddenlayer1,
...
optimizer2 = SGDInvertible(network=network, threshold=0.000001,
                           init_step_size=0.005, tau=tau,
                           final_step_size=0.004,
